...
module tb_ws281x_consumer;
    localparam AXIL_ADDR_WIDTH = pl_config_pkg::CONTROL_ADDR_WIDTH;
    localparam FRAME_ADDR_WIDTH = 10;
    localparam OUTPUT_COUNT = pl_config_pkg::OUTPUT_COUNT;
    localparam PIXELS_PER_OUTPUT = 2;
    localparam FRAME_WORDS = 160;
    localparam [31:0] PL_CONTROL_ID_VALUE = pl_config_pkg::REG_ID_RESET;
    localparam [31:0] PL_CONTROL_VERSION_VALUE = pl_config_pkg::REG_VERSION_RESET;
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_ID_OFFSET = pl_config_pkg::REG_ID_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_VERSION_OFFSET = pl_config_pkg::REG_VERSION_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONTROL_OFFSET = pl_config_pkg::REG_CONTROL_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_STATUS_OFFSET = pl_config_pkg::REG_STATUS_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_FRAME_COMMIT_OFFSET = pl_config_pkg::REG_FRAME_COMMIT_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_FRAME_COUNT_OFFSET = pl_config_pkg::REG_FRAME_COUNT_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_COMMITTED_WORDS_OFFSET = pl_config_pkg::REG_COMMITTED_WORDS_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_ERROR_COUNT_OFFSET = pl_config_pkg::REG_ERROR_COUNT_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_FRAME_BANK_WORDS_OFFSET = pl_config_pkg::REG_FRAME_BANK_WORDS_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_ACTIVE_BANK_OFFSET = pl_config_pkg::REG_ACTIVE_BANK_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_WRITE_BANK_OFFSET = pl_config_pkg::REG_WRITE_BANK_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_FRAME_SEQUENCE_OFFSET = pl_config_pkg::REG_FRAME_SEQUENCE_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONSUMER_CONTROL_OFFSET = pl_config_pkg::REG_CONSUMER_CONTROL_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONSUMER_STATUS_OFFSET = pl_config_pkg::REG_CONSUMER_STATUS_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONSUMER_SEQUENCE_OFFSET = pl_config_pkg::REG_CONSUMER_SEQUENCE_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONSUMER_FRAME_COUNT_OFFSET = pl_config_pkg::REG_CONSUMER_FRAME_COUNT_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONSUMER_ERROR_COUNT_OFFSET = pl_config_pkg::REG_CONSUMER_ERROR_COUNT_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONSUMER_DEBUG_OFFSET = pl_config_pkg::REG_CONSUMER_DEBUG_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_WRITE_BANK_VALID_OFFSET = pl_config_pkg::REG_WRITE_BANK_VALID_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_BUSY_BANK_OFFSET = pl_config_pkg::REG_BUSY_BANK_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_FRAME_DROPPED_OFFSET = pl_config_pkg::REG_FRAME_DROPPED_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_FRAME_REJECTED_OFFSET = pl_config_pkg::REG_FRAME_REJECTED_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_FRAME_DROP_NOTIFY_OFFSET = pl_config_pkg::REG_FRAME_DROP_NOTIFY_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_ACTIVE_OUTPUT_COUNT_OFFSET = pl_config_pkg::REG_ACTIVE_OUTPUT_COUNT_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_STRAND_PIXEL_COUNT_OFFSET = pl_config_pkg::REG_STRAND_PIXEL_COUNT_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_CONFIG_STATUS_OFFSET = pl_config_pkg::REG_CONFIG_STATUS_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_STRAND_LENGTH_CLAMPED_OFFSET = pl_config_pkg::REG_STRAND_LENGTH_CLAMPED_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [AXIL_ADDR_WIDTH-1:0] PL_CONTROL_OUTPUT_INVERT_MASK_OFFSET = pl_config_pkg::REG_OUTPUT_INVERT_MASK_OFFSET[AXIL_ADDR_WIDTH-1:0];
    localparam [31:0] PL_CONTROL_STATUS_READY = pl_config_pkg::REG_STATUS_ready_MASK;
    localparam [31:0] PL_CONTROL_STATUS_OVERFLOW = pl_config_pkg::REG_STATUS_overflow_MASK;
    localparam [31:0] PL_CONTROL_STATUS_COMMIT_REJECTED = pl_config_pkg::REG_STATUS_commit_rejected_MASK;
    localparam [31:0] PL_CONTROL_CONTROL_CLEAR_ERRORS = pl_config_pkg::REG_CONTROL_clear_errors_MASK;
    localparam [31:0] PL_CONTROL_CONSUMER_ENABLE = pl_config_pkg::REG_CONSUMER_CONTROL_enable_MASK;
    localparam [31:0] PL_CONTROL_CONSUMER_RESET = pl_config_pkg::REG_CONSUMER_CONTROL_reset_fsm_MASK;
    localparam [31:0] PL_CONTROL_CONSUMER_BUSY = pl_config_pkg::REG_CONSUMER_STATUS_busy_MASK;
    ...
    ws281x_controller_core #(
        ...
        .CLK_HZ(100000000),
        .WS281X_BIT_RATE(pl_config_pkg::WS281X_BIT_RATE)
    ) dut (
        .aclk(aclk),
        .aresetn(aresetn),
    ...
    initial begin
        ...
        if (read_data != pl_config_pkg::DEFAULT_ACTIVE_OUTPUT_COUNT) begin
            $fatal(1, "default active output count is %08x", read_data);
        end
        ctl_read(PL_CONTROL_OUTPUT_INVERT_MASK_OFFSET, read_data);
        if (read_data != pl_config_pkg::DEFAULT_OUTPUT_INVERT_MASK) begin
