...
module eth_control_core #(
    ...
    localparam [AXIL_ADDR_WIDTH-1:0] REG_FRAME_COMMIT    = 12'h020;
    localparam [AXIL_ADDR_WIDTH-1:0] REG_FRAME_COUNT     = 12'h024;
    localparam [AXIL_ADDR_WIDTH-1:0] REG_COMMITTED_WORDS = 12'h028;
